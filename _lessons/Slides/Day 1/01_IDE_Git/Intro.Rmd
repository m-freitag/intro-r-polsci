---
title: "Intro, (Git)Hub and R-Studio"
subtitle: ""  
author: 
  - "Markus Freitag"
date: '`r Sys.Date()`'
...
Source: [Julia Micro-Benchmarks](https://julialang.org/benchmarks/).
![:scale 70=%](Figs/benchmarks.svg)
...
<div align="center">
<img src="https://www.economist.com/img/b/1000/590/90/sites/default/files/images/2021/04/articles/main/20210417_woc511.png" height=500>
</div>
...
p <- cjpowr_plotly(y = "n", x = "amce", by = "power",
amce = seq(from = 0.02, to = 0.1, length.out = 1000),
power = c(0.7,0.8,0.9),
alpha = 0.05,
levels = 5,
delta0=0.5) %>% plotly::layout(plot_bgcolor='rgb(246, 243, 242)',
...
1. Click [here](https://github.com/new) and create a new (Git)Hub repo. Call it "test", set it to private and initialize with readme.
