...
> *"I want to give a short (crash) course that provides you with some basic practical skills necessary to get serious about quantitative research."* 
...
2\. .hl[Code chunks] sorrounded by ` ``` `. You can execute each chunk individually. 

3\. .hl[Plain text] formatted via Markdown, a markup language with very [easy syntax](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf).
...
- Instead of some folder, your project lives in a remote .hl2[repository.]
...
&#x2192; You can .hl2[fork] some repo (including those of other users); i.e. create a copy of the repo under "your repositories". You can then **clone** this forked repo to get a local copy.
...
Pulling .hl[after] commiting does .hl[not] overwrite your work. If you committed, 
what you pull get's compared to what you comitted. It's things conflict, it's up to you
